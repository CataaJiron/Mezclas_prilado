...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    # Caja de fórmulas auditables
    #with st.expander("📐  Fórmulas y auditoría"):
    #    st.markdown("""
...
#- `ley_i` = porcentaje del componente en el cristal i
#- La suma recorre todas las corrientes activas con masa > 0
#        """)
